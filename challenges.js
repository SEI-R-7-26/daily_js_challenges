...
- Write a function called range that accepts two integers as arguments and
 returns an array of integers starting with the first argument up to one less than the second argument.
- The range function must be called with the first argument less than or equal
 to the second argument, otherwise return the string "First argument must be less than second".
...
- Write a function called removeEnds that accepts a single string argument, then returns the a string with 
...
function charCount(string) {
  for (i = 0; i < string.length; i++) {
    count = string.charAt(i).toUpperCase() + count
  }
  return count
}
/*-----------------------------------------------------------------
...
- Write a function called formatWithPadding that accepts three arguments:
  ...
  - A string argument (a single character) representing the character used 
    to "pad" the returned string to a minimum length.
...
In information theory, the hamming distance refers to the count of the differences between
 two strings of equal length.  It is used in computer science for such things as implementing "fuzzy search"  capability.

- Write a function named hammingDistance that accepts two arguments which are both strings of equal length.
- The function should return the count of the symbols 
(characters, numbers, etc.) at the same position within each string that are different.
...
to its position within the string arg.  In addition, 
...
- Each nested array will have two elements representing key/value 
 pairs used to create key/value pairs in an object to be returned by the function.
...
function fromPairs(arr) {
  let obj = {}
  arr.forEach(function (nesArr) {
    obj[nesArr[0]] = nesArr[1]
  })
  return obj
}
/*-----------------------------------------------------------------
...
- The addChecker function should return true if there are two 
  integers in the array of integers (first argument) that when added together, 
