...
function reverseUpcaseString(string) {
  ...
  for (let i = 0; i < string.length; i++) {
    answer = string.charAt(i).toUpperCase() + answer
  }
  return answer
}
/*-----------------------------------------------------------------
...
function intersection(arr1, arr2) {
  ...
  arr1.forEach((val) => {
    ...
    if (idx > -1) answer.push(_arr2.splice(idx, 1)[0])
  })
  return answer
}
/*-----------------------------------------------------------------
...
function gridTrip(arr, string) {
  ...
  while (idx < string.length) {
    ...
    result[lookup[dir][0]] += numStr * lookup[dir][1]
  }
  return result
}
/*-----------------------------------------------------------------
